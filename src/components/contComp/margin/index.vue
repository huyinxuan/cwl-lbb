    ...
    <main class="page-trade margin">
      <div class="trade-symbol upper">
        <p>
          ...
          <span action="expand" data-base="btc" data-quote="usdt">btc / usdt</span>
          <span class="actions">
            <i class="mobile_icon_fav" action="fav"></i>
            <i class="mobile_icon_chart" action="chart"></i>
          </span>
        </p>
      </div>
      <div class="margin-risk">
        <div class="info">
          <dl>
            <dt>---</dt>
            <dd>可用ONT</dd>
        ...
        <div class="trade-panel--content">
          <div class="fl trade-form buy" id="trade-form" growing-ignore="true">
            <div class="input-box input-price">
              <input autocomplate="new-password" id="price" min="0" placeholder="价格" type="number" />
              <span class="actions" id="price-actions">
                <i data-action="dec"></i>
                <i data-action="inc"></i>
              </span>
            </div>
            <div class="equivalent">
              <span>
                ≈
                <em id="price-equivalent">¥59401.21</em>
              </span>
            </div>
            <div class="input-box input-amount">
              <input autocomplate="new-password" id="amount" min="0" placeholder="数量" type="number" />
              <span class="upper" id="amount-coin" data-amountcoin="btc">btc</span>
            </div>
            <div class="avaliable">
              <dl growing-ignore="true">
                <dt class="fl">可用</dt>
                <dd class="upper base-balance">
                  <span id="base-balance" data-basebalance="--">--</span>
                  <em data-base="btc">btc</em>
                </dd>
                <dd class="upper quote-balance">
                  <span id="quote-balance" data-quotebalance="--">--</span>
                  <em data-quote="usdt">usdt</em>
                </dd>
              </dl>
            </div>
            ...
            <button
              class="upper submit"
              data-base="btc"
              data-directtext="买入(做多)"
              id="submit"
            >买入(做多) btc</button>
          </div>
          <div class="fr handicap" id="handicap">
            <div class="handicap-title">
              <span class="index">盘口</span>
              <span class="price">价格</span>
              <span class="amount">数量</span>
            </div>
            <div class="handicap-sell" id="handicap-sell">
              <dl style="background-size:15% 100%;" data-price="8361.00">
                <dt class="fl">5</dt>
                <dd class="fl">8361.00</dd>
                <dd class="fr">0.350077</dd>
              </dl>
              <dl style="background-size:87% 100%;" data-price="8360.92">
                <dt class="fl">4</dt>
                <dd class="fl">8360.92</dd>
                <dd class="fr">2.000000</dd>
              </dl>
              <dl style="background-size:100% 100%;" data-price="8360.91">
                <dt class="fl">3</dt>
                <dd class="fl">8360.91</dd>
                <dd class="fr">2.310000</dd>
              </dl>
              <dl style="background-size:11% 100%;" data-price="8360.60">
                <dt class="fl">2</dt>
                <dd class="fl">8360.60</dd>
                <dd class="fr">0.250000</dd>
              </dl>
              <dl style="background-size:30% 100%;" data-price="8360.48">
                <dt class="fl">1</dt>
                <dd class="fl">8360.48</dd>
                <dd class="fr">0.699589</dd>
              </dl>
            </div>
            <div class="handicap-price">
              <em id="nowprice" data-nowprice="8360.52">8360.52</em>
              <b class="rate">---</b>
              <span>
                ≈
                <b id="now-price-equivalent">¥59412.01</b>
              </span>
            </div>
            <div class="handicap-buy" id="handicap-buy">
              <dl style="background-size:0% 100%;" data-price="8360.13">
                <dt class="fl">1</dt>
                <dd class="fl">8360.13</dd>
                <dd class="fr">0.000231</dd>
              </dl>
              <dl style="background-size:2% 100%;" data-price="8360.11">
                <dt class="fl">2</dt>
                <dd class="fl">8360.11</dd>
                <dd class="fr">0.050000</dd>
              </dl>
              <dl style="background-size:3% 100%;" data-price="8360.00">
                <dt class="fl">3</dt>
                <dd class="fl">8360.00</dd>
                <dd class="fr">0.057922</dd>
              </dl>
              <dl style="background-size:0% 100%;" data-price="8359.99">
                <dt class="fl">4</dt>
                <dd class="fl">8359.99</dd>
                <dd class="fr">0.001075</dd>
              </dl>
              <dl style="background-size:28% 100%;" data-price="8359.98">
                <dt class="fl">5</dt>
                <dd class="fl">8359.98</dd>
                <dd class="fr">0.657574</dd>
              </dl>
            </div>
            <div class="handicap-depth">
              <a href="/zh-cn/orderbook/">更多</a>
              <div class="select-box">
      ...
      <div class="trade-order">
        <div class="trade-order--title">
          ...
          <span class="fr" id="to-history">
            <i class="mobile_icon_history"></i>委托历史
          </span>
        </div>
...
.page-trade.margin .margin-risk .risk.warn .progress {
  background-image: linear-gradient(90deg, rgba(209, 75, 100, 0.75), #d14b64);
}
...
.page-trade .trade-panel--content .trade-form .equivalent em,
.page-trade .trade-panel--content .trade-form .equivalent span {
  vertical-align: unset;
}
...
.page-trade .trade-panel--content .trade-form .total.market,
.page-trade .trade-panel--content .trade-form .total.market em {
  color: transparent;
}
...
.page-trade .trade-panel--content .handicap-buy,
...
.page-trade .trade-panel--content .handicap-buy dt,
.page-trade .trade-panel--content .handicap-sell dt {
  width: 24px;
}

.page-trade .trade-panel--content .handicap-buy dd,
.page-trade .trade-panel--content .handicap-sell dd {
  letter-spacing: -1px;
}

.page-trade .trade-panel--content .handicap-buy dd:last-of-type,
.page-trade .trade-panel--content .handicap-sell dd:last-of-type {
  color: #8c9fad;
  margin-right: 30px;
}
