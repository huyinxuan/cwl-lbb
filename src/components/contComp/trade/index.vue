<template>
  <div>
    <header>
      <img alt="Huobi Global" src="@/assets/home-logo2.svg" />
    </header>
    <main class="page-trade margin">
        <div class="trade-symbol upper">
            <p><i class="mobile_icon_expand" action="expand"></i> <span action="expand" data-base="btc"
                    data-quote="usdt">btc / usdt</span> <span class="actions"><i class="mobile_icon_fav" action="fav"></i>
                    <i class="mobile_icon_chart" action="chart"></i></span></p>
        </div>
        <div class="trade-panel" growing-ignore="true">
            <div class="trade-panel--title" id="trade-pannel-tabs"><button class="btn color-buy cur"
                    data-direct="buy">买入</button> <button class="btn color-sell" data-direct="sell">卖出</button>
                <div class="select-box"><select id="trade-type" name="trade-type">
            ...
            <div class="trade-panel--content">
                <div class="fl trade-form buy" id="trade-form" growing-ignore="true">
                    <div class="input-box input-price"><input autocomplate="new-password" id="price" min="0"
                            placeholder="价格" type="number"> <span class="actions" id="price-actions"><i
                                data-action="dec"></i> <i data-action="inc"></i></span></div>
                    <div class="equivalent"><span>≈<em id="price-equivalent">¥58719.38</em></span></div>
                    <div class="input-box input-amount"><input autocomplate="new-password" id="amount" min="0"
                            placeholder="数量" type="number"> <span class="upper" id="amount-coin"
                            data-amountcoin="btc">btc</span></div>
                    <div class="avaliable">
                        <dl growing-ignore="true">
                            <dt class="fl">可用</dt>
                            <dd class="upper base-balance"><span id="base-balance" data-basebalance="--">--</span><em
                                    data-base="btc">btc</em></dd>
                            <dd class="upper quote-balance" style="display:none"><span id="quote-balance"
                                    data-quotebalance="--">--</span><em data-quote="usdt">usdt</em></dd>
                        </dl>
                    </div>
                    <div class="btn-group" id="position"><button data-proportion="0.25">1/4</button> <span></span> <button
                            data-proportion="0.5">1/2</button> <span></span> <button data-proportion="1">全仓</button></div>
                    <div class="total" id="total"><span>交易额 <em class="upper" data-total="--">--</em> <em class="upper"
                                data-quote="usdt">usdt</em></span></div><button class="upper submit" data-base="btc"
                        data-directtext="买入" id="submit">买入 btc</button>
                </div>
                <div class="fr handicap" id="handicap">
                    ...
                    <div class="handicap-sell" id="handicap-sell">
                        <dl style="background-size:1% 100%;" data-price="8282.74">
                            <dt class="fl">5</dt>
                            <dd class="fl">8282.74</dd>
                            <dd class="fr">0.015000</dd>
                        </dl>
                        <dl style="background-size:0% 100%;" data-price="8282.66">
                            <dt class="fl">4</dt>
                            <dd class="fl">8282.66</dd>
                            <dd class="fr">0.002000</dd>
                        </dl>
                        <dl style="background-size:2% 100%;" data-price="8282.65">
                            <dt class="fl">3</dt>
                            <dd class="fl">8282.65</dd>
                            <dd class="fr">0.030000</dd>
                        </dl>
                        <dl style="background-size:1% 100%;" data-price="8282.11">
                            <dt class="fl">2</dt>
                            <dd class="fl">8282.11</dd>
                            <dd class="fr">0.012100</dd>
                        </dl>
                        <dl style="background-size:37% 100%;" data-price="8282.00">
                            <dt class="fl">1</dt>
                            <dd class="fl">8282.00</dd>
                            <dd class="fr">0.466364</dd>
                        </dl>
                    </div>
                    <div class="handicap-price"><em id="nowprice" data-nowprice="8282.00">8282.00</em> <b
                            class="rate">---</b> <span>≈<b id="now-price-equivalent">¥58719.38</b></span></div>
                    <div class="handicap-buy" id="handicap-buy">
                        <dl style="background-size:100% 100%;" data-price="8281.99">
                            <dt class="fl">1</dt>
                            <dd class="fl">8281.99</dd>
                            <dd class="fr">1.247068</dd>
                        </dl>
                        <dl style="background-size:20% 100%;" data-price="8281.90">
                            <dt class="fl">2</dt>
                            <dd class="fl">8281.90</dd>
                            <dd class="fr">0.250000</dd>
                        </dl>
                        <dl style="background-size:0% 100%;" data-price="8280.73">
                            <dt class="fl">3</dt>
                            <dd class="fl">8280.73</dd>
                            <dd class="fr">0.002000</dd>
                        </dl>
                        <dl style="background-size:5% 100%;" data-price="8280.63">
                            <dt class="fl">4</dt>
                            <dd class="fl">8280.63</dd>
                            <dd class="fr">0.063000</dd>
                        </dl>
                        <dl style="background-size:22% 100%;" data-price="8280.53">
                            <dt class="fl">5</dt>
                            <dd class="fl">8280.53</dd>
                            <dd class="fr">0.269400</dd>
                        </dl>
                    </div>
                    <div class="handicap-depth"><a href="/zh-cn/orderbook/">更多</a>
        ...
        <div class="trade-order">
            <div class="trade-order--title">当前委托 <span class="fr" id="to-history"><i
...
.page-trade .trade-panel--title button.cur {
...
.page-trade .trade-panel--content .trade-form .input-box input.market {
    padding-right: 20px
}

.page-trade .trade-panel--content .trade-form .input-box input:disabled {
    background: #f7f7fb;
    color: #8c9fad;
    -webkit-text-fill-color: #8c9fad;
    font-weight: 400
}

.page-trade .trade-panel--content .trade-form .input-box input::-webkit-input-placeholder {
    color: #c5cfd5
}

.page-trade .trade-panel--content .trade-form .input-box input:-moz-placeholder {
    color: #c5cfd5
}
